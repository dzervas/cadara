...
import { authoredDefinitionValue } from "@/core/feature-authoring/features/authored-value-helpers";

export function isAdvancedOperationIntent(
  value: unknown,
...
export function validateAdvancedSolidDraft(input: {
  ...
  participants: readonly ReturnType<
    typeof buildAdvancedSolidParticipants
  >[number][];
