  ...
  requirements: [
    {
      ...
      description:
        "Bodies, topology, sketches, features, and construction references are selectable.",
      slots: [
        {
  ...
  requirements: [
    {
      ...
      label: "Sketch references",
      description:
        "Select sketch geometry or the owning sketch plane while editing a sketch.",
      slots: [
        {
          id: "sketch-reference",
  ...
  requirements: [
    {
      ...
      label: "Reference geometry",
      description:
        "Select model topology or existing sketch geometry to reference in the active sketch.",
      slots: [
        {
          id: "sketch-external-reference-target",
          label: "Reference target",
          description:
            "Select one model face, edge, vertex, existing sketch, sketch entity, or sketch point.",
          acceptedKinds: [
            "face",
            "edge",
            "vertex",
  ...
  requirements: [
    {
      ...
      description:
        "Select one measurable body, topology target, sketch primitive, projected curve, or region.",
      slots: [
        {
  ...
  requirements: [
    {
      ...
      label: "Sketch plane",
      description:
        "Start a sketch from a construction plane or planar face, or reopen an existing sketch.",
      slots: [
        {
          id: "sketch-start-target",
          label: "Sketch start target",
          description:
            "Select one construction plane, one planar face, or one existing sketch.",
  ...
  requirements: [
    {
      ...
      label: "Section seed",
      description:
        "Section view accepts one planar face, closed region, or construction plane.",
      slots: [
        {
          id: "section-view-seed",
          label: "Section seed",
          description:
            "Select one planar face, closed region, or construction plane.",
...
export const extrudeSelectionFilter: SelectionFilter = {
  ...
  requirements: [
    ...
    },
    {
      ...
      label: "Extrude seed",
      description:
        "Extrude accepts one or more explicit derived sketch regions or planar faces.",
      slots: [
        {
          id: "extrude-seed",
          label: "Extrude seed",
          description:
            "Select one or more derived sketch regions or planar faces.",
    ...
    },
    {
      ...
      description:
        "The active extrude boolean target selector accepts durable body targets only.",
      slots: [
        {
          id: "extrude-target-body",
          label: "Boolean target body",
          description:
            "Select one target body for the extrude boolean operation.",
          acceptedKinds: ["body"],
          acceptedSemantics: ["body"],
        },
      ],
...
export const revolveSelectionFilter: SelectionFilter = {
  ...
  requirements: [
    ...
    },
    {
      ...
      description:
        "Revolve accepts one or more explicit region or planar face profiles.",
      slots: [
        {
          id: "revolve-profile",
    ...
    },
    {
      ...
      label: "Axis target",
      description:
        "Revolve accepts one explicit durable edge or construction axis.",
      slots: [
        {
          id: "revolve-axis",
          label: "Revolve axis",
  ...
  requirements: [
    {
      ...
      label: "Profile target",
      description:
        "Sweep accepts one or more explicit region or planar face profiles.",
      slots: [
        {
          id: "sweep-profile",
          label: "Sweep profile",
    ...
    },
    {
      ...
      label: "Path target",
      description:
        "Sweep accepts one durable edge or sketch entity as its initial path.",
      slots: [
        {
          id: "sweep-path",
          label: "Sweep path",
    ...
    },
    {
      ...
      label: "Guide curve",
      description:
        "Guide curves are contract-visible but not yet supported by the OCC sweep builder.",
      slots: [
        {
          id: "sweep-guide-curve",
          label: "Guide curve",
    ...
    },
    {
      ...
      description:
        "Lock profile direction accepts one durable edge or construction target.",
      slots: [
        {
          id: "sweep-lock-profile-direction",
          label: "Lock profile direction",
    ...
    },
    {
      ...
      label: "Boolean target",
      description:
        "Add, subtract, and intersect require one explicit target body.",
      slots: [
        {
          id: "sweep-boolean-target",
          label: "Boolean target",
  ...
  requirements: [
    {
      ...
      label: "Profile target",
      description:
        "Loft accepts two or more explicit region or planar face profiles in user-defined order.",
      slots: [
        {
          id: "loft-profile",
          label: "Loft profile",
    ...
    },
    {
      ...
      label: "Path",
      description:
        "Loft accepts one optional path control separately from guide curves.",
      slots: [
        {
          id: "loft-path",
          label: "Loft path",
    ...
    },
    {
      ...
      label: "Guide curve",
      description:
        "Loft accepts optional guide curves separately from path controls.",
      slots: [
        {
          id: "loft-guide-curve",
          label: "Guide curve",
...
export const splitSelectionFilter: SelectionFilter = {
  ...
  requirements: [
    ...
    },
    {
      ...
      description:
        "The initial split implementation accepts one explicit durable tool body.",
      slots: [
        {
          id: "split-tool-body",
          label: "Split tool body",
      ...
      slots: [
        {
          ...
          label: "Target body",
          description:
            "Select one or more bodies to receive the boolean result.",
          acceptedKinds: ["body"],
          acceptedSemantics: ["body"],
        },
      ],
  ...
  requirements: [
    {
      ...
      label: "Body target",
      description:
        "Delete-solid accepts one or more explicit durable body targets.",
      slots: [
        {
          id: "delete-solid-body",
          label: "Body target",
  ...
  requirements: [
    {
      ...
      label: "Body target",
      description:
        "Mirror accepts one or more explicit durable body targets in the first slice.",
      slots: [
        {
          id: "mirror-body",
          label: "Body target",
    ...
    },
    {
      ...
      label: "Mirror plane",
      description:
        "Mirror requires one explicit planar face or construction plane reference.",
      slots: [
        {
          id: "mirror-plane",
          label: "Mirror plane",
  ...
  requirements: [
    {
      ...
      label: "Body target",
      description:
        "Transform accepts one or more explicit durable body targets in the first slice.",
      slots: [
        {
          id: "transform-body",
          label: "Body target",
    ...
    },
    {
      ...
      description:
        "The first transform slice translates bodies along the normal of one explicit planar reference.",
      slots: [
        {
          id: "transform-reference",
          label: "Transform reference",
  ...
  requirements: [
    {
      ...
      description:
        "Plane creation accepts one planar face or one construction plane in the current contract.",
      slots: [
        {
...
export const shellSelectionFilter: SelectionFilter = {
  ...
  requirements: [
    ...
    },
    {
      ...
      description:
        "Shell accepts one explicit removable face per selection interaction.",
      slots: [
        {
          id: "shell-face",
          label: "Removable face",
    ...
    },
    {
      ...
      label: "Boolean target body",
      description:
        "The active shell boolean target selector accepts durable body targets only.",
      slots: [
        {
          id: "shell-boolean-target",
          label: "Boolean target body",
          description:
            "Select one target body for the shell boolean operation.",
          acceptedKinds: ["body"],
          acceptedSemantics: ["body"],
        },
      ],
...
export function isDurablePrimitiveRef(
  target: PrimitiveRef,
): target is DurableRef {
  return (
...
export function getDefaultSelectionFilterForMode(
  mode: ToolbarMode,
): SelectionFilter {
...
export function createSelectionFilterForRequirement(
  ...
  const requirement = filter.requirements.find(
...
function slotAcceptsTarget(
  ...
  return slot.acceptedSemantics.some((semantic) =>
...
export function getSelectionFilterRejectionLabel(
  ...
  const requirementLabels = filter.requirements.map((requirement) =>
    requirement.label.toLowerCase(),
  );
  const expectedLabel =
    requirementLabels.length > 0
      ? requirementLabels.join(" or ")
