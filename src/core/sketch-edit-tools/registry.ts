...
export const sketchEditToolDefinitions = [
  ...
  },
  {
    metadata: {
      ...
      name: "Slot",
      tooltip:
        "Create slot boundary geometry around selected sketch references.",
      icon: "sketchSlot",
      modes: ["sketch"],
      selection: {
  ...
  },
  {
    metadata: {
      ...
      validationMessages: {
        ...
        unsupportedTarget:
          "Sketch mirror supports sketch entities and needs a line as the final mirror axis.",
      },
  ...
  },
  {
    metadata: {
      ...
      validationMessages: {
        ...
        unsupportedTarget:
          "Sketch linear pattern supports point, line, circle, arc, and spline entities.",
      },
  ...
  },
  {
    metadata: {
      ...
      validationMessages: {
        emptySelection: "Select sketch geometry to pattern.",
        unsupportedTarget:
          "Sketch circular pattern supports point, line, circle, arc, and spline entities.",
      },
  ...
  },
  {
    metadata: {
      ...
      validationMessages: {
        ...
        unsupportedTarget:
          "Sketch transform supports point, line, circle, arc, and spline entities.",
      },
...
const sketchEditToolRegistry = createRegistry<
  SketchEditToolId,
  SketchEditToolDefinition
>(
...
export function getSketchEditToolDefinition(
  toolId: SketchEditToolId,
): SketchEditToolDefinition {
  return sketchEditToolRegistry.get(toolId);
}

export function isRegisteredSketchEditToolId(
  toolId: string,
): toolId is SketchEditToolId {
