      ...
      bodies: [
        {
          ...
          topology: {
            ...
            edges: [
              ...
              ...makeCadaraBrepRecord().data!.bodies[0]!.topology.edges.slice(
                1,
              ),
            ],
            coedges: [
              ...
              ...makeCadaraBrepRecord().data!.bodies[0]!.topology.coedges.slice(
                1,
              ),
            ],
          },
      ...
      bodies: [
        {
          ...
          topology: {
            ...
            faces: base
              .data!.bodies[0]!.topology.faces.slice(0, 3)
              .map((face) => ({
                ...face,
                loopIndices: [0],
              })),
