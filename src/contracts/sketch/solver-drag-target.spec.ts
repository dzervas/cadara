...
test("src/contracts/sketch/solver-drag-target.spec.ts", () => {
  ...
  function testDraggedPointSolvesFreeSquareTranslation() {
    ...
    assertClosePoint(
      ...
      [3, 3],
      "Dragged-point solve should translate A.",
    );
    assertClosePoint(
      points.get("sketch_point_b"),
      [4, 3],
      "Dragged-point solve should honor the target point.",
    );
    assertClosePoint(
      points.get("sketch_point_c"),
      [4, 4],
      "Dragged-point solve should translate C.",
    );
    assertClosePoint(
      points.get("sketch_point_d"),
      [3, 4],
      "Dragged-point solve should translate D.",
    );
  }
  ...
  function testDraggedPointSolvesRectangleToolTranslation() {
    ...
    for (const point of definition.points) {
      ...
      assertClosePoint(
        points.get("sketch_point_rect_bottom_left"),
        [2, 2],
        "Rectangle translation should move bottom left.",
      );
      assertClosePoint(
        points.get("sketch_point_rect_bottom_right"),
        [6, 2],
        "Rectangle translation should move bottom right.",
      );
      assertClosePoint(
        points.get("sketch_point_rect_top_right"),
        [6, 5],
        "Rectangle translation should move top right.",
      );
      assertClosePoint(
        points.get("sketch_point_rect_top_left"),
        [2, 5],
        "Rectangle translation should move top left.",
      );
    }
  }
