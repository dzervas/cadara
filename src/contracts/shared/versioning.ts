 ...
 */
export type OperationHistorySchemaVersion =
  "modeling-operation-history/v1alpha1";

/**
 * Authored model document payload schema version.
 * This version applies only to the local-first persisted authored CAD state.
 */
export type AuthoredModelDocumentSchemaVersion =
  "authored-model-document/v1alpha1";
 ...
 */
export type GeometryAssetManifestSchemaVersion =
  "geometry-asset-manifest/v1alpha1";
 ...
 */
export const OPERATION_HISTORY_SCHEMA_VERSION: OperationHistorySchemaVersion =
  "modeling-operation-history/v1alpha1";

/**
 * Current authored model document schema version literal.
 */
export const AUTHORED_MODEL_DOCUMENT_SCHEMA_VERSION: AuthoredModelDocumentSchemaVersion =
  "authored-model-document/v1alpha1";

/**
 * Current immutable geometry asset record schema version literal.
 */
export const GEOMETRY_ASSET_SCHEMA_VERSION: GeometryAssetSchemaVersion =
  "geometry-asset/v1alpha1";

/**
 * Current authored geometry asset manifest schema version literal.
 */
export const GEOMETRY_ASSET_MANIFEST_SCHEMA_VERSION: GeometryAssetManifestSchemaVersion =
  "geometry-asset-manifest/v1alpha1";

/**
 * Current import-provider contract schema version literal.
 */
export const IMPORT_CONTRACT_SCHEMA_VERSION: ImportContractSchemaVersion =
  "import-contract/v1alpha1";
 ...
 */
export const FILLET_FEATURE_SCHEMA_VERSION: FilletFeatureSchemaVersion =
  "feature-type/fillet/v1alpha1";

/**
 * Current plane feature schema version literal.
 */
export const PLANE_FEATURE_SCHEMA_VERSION: PlaneFeatureSchemaVersion =
  "feature-type/plane/v1alpha1";
 ...
 */
export const RENDER_EXPORT_SCHEMA_VERSION: RenderExportSchemaVersion =
  "render-export/v1alpha1";
