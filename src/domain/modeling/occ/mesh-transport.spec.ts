...
import {
  packWorkspaceSnapshotRenderMeshes,
  unpackWorkspaceSnapshotRenderMeshes,
} from "@/domain/modeling/occ/mesh-transport";

test("src/domain/modeling/occ/mesh-transport.spec.ts", () => {
  const meshRecord = {
