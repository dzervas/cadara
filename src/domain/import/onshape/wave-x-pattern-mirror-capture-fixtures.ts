    ...
    partStudios: [
      {
        ...
        profileEvidence: [
          ["BASE_EXTRUDE", "BASE_SKETCH", [0, 0, 0]],
          ["FOKYXKU0uqy9EB3_2", "SEED_6_SKETCH", [0.01, 0.01, 0]],
          ["F2B5cy3xMm2MHNU_2", "SEED_7_SKETCH", [0.01, -0.01, 0]],
        ].map(([consumingFeatureId, sourceSketchFeatureId, interiorPoint3d]) => ({
          consumingFeatureId,
          parameterId: "entities" as const,
          queryIndex: 0,
          resultIndex: 0,
          deterministicId: `pattern-profile:${consumingFeatureId}`,
          evaluatedAt: "historyPoint" as const,
