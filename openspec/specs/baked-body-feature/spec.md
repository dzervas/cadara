# baked-body-feature Specification

## Purpose
Defines the baked-body modeling feature: durable kernel bodies materialized from registered geometry assets, their honest editability and body-only presentation, replacement scope, explicit component membership, and the injected asset-resolution seam shared by baking writers and kernel readers.
